defmodule LifelinePhoenix.Patients.Patient do
  ...
  def changeset(patient, attrs) do
    patient
    |> cast(attrs, [:first_name, :last_name, :national_id, :telephone, :blood_group, :date_of_birth, :diabetic, :hypertensive, :asthmatic, :doctor_id])
    |> validate_required([:first_name, :last_name, :national_id, :telephone, :blood_group, :date_of_birth, :diabetic, :hypertensive, :asthmatic, :doctor_id])
  end
end
