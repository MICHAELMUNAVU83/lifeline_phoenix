defmodule LifelinePhoenixWeb.DoctorAuthTest do
  use LifelinePhoenixWeb.ConnCase, async: true

  alias LifelinePhoenix.Accounts
  alias LifelinePhoenixWeb.DoctorAuth
  import LifelinePhoenix.AccountsFixtures

  @remember_me_cookie "_lifeline_phoenix_web_doctor_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, LifelinePhoenixWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_doctor/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      LifelinePhoenixWeb.Endpoint.subscribe(live_socket_id)
